              ...
              <div className="relative flex-1 flex flex-col max-w-xs w-full bg-white focus:outline-none">
                ...
                <div className="flex-shrink-0 flex border-t border-gray-200 p-4">
                  {user ? (
                    ...
                    <Link to={"/login"} className="flex-shrink-0 group block p-8 rounded-lg text-indigo-200 hover:bg-indigo-700">
                      <div className="flex items-center">
                        <LoginIcon className="h-6 w-6 items-center" aria-hidden="true" />
        ...
        <div className="hidden lg:flex lg:flex-shrink-0">
          <div className="flex flex-col w-20">
            <div className="flex-1 flex flex-col min-h-0 overflow-y-auto bg-indigo-600">
              ...
              <div className="flex-shrink-0 flex-col pb-5">
                {user ? (
                  <a href="#" onClick={logout} className="flex-shrink-0 w-full">
